...
const CATEGORIES: Category[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        src: '/images/retrato-corporativo/retrato-executivo-sao-paulo-ivan-dias-03.jpg',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        src: '/images/og-ivan-dias-fotografo.jpg',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        src: '/images/eventos-corporativos/cobertura-evento-corporativo-sao-paulo-ivan-dias-02.jpg',
      },
      {
        label: 'Evento de premiação corporativa - São Paulo - Ivan Dias',
        src: '/images/eventos-corporativos/evento-premiacao-corporativo-sao-paulo-ivan-dias-03.jpg',
      },
      {
      ...
      },
      {
        ...
        src: '/images/eventos-corporativos/palestra-corporativa-sao-paulo-ivan-dias-05.jpg',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        src: '/images/portfolio/equipe-industrial-sao-paulo-ivan-dias-01.jpg',
      },
      {
        label: 'Equipe de operações em planta industrial - São Paulo - Ivan Dias',
        src: '/images/portfolio/industria-sao-paulo-ivan-dias-02.jpg',
      },
      {
        label: 'Colaborador em ambiente industrial - São Paulo - Ivan Dias',
        src: '/images/portfolio/colaborador-industria-sao-paulo-ivan-dias-03.jpg',
      },
      {
        label: 'Fotografia corporativa industrial - São Paulo - Ivan Dias',
        src: '/images/portfolio/galpao-industrial-sao-paulo-ivan-dias-04.jpg',
      },
    ],
  },
];
